...
const TermsCondition = () => {
  return (
    <div className="mt-[92px] ">
      ...
      <div className="p-5 mt-5 md:p-0 container m-auto text-justify" >
        ...
        <p>
          ...
          use of Savali Bahuddyeshiy Sanstha Website, located at
          savalibahuddyeshiysanstha.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Savali Bahuddyeshiy Sanstha if you
        ...
        <p>
          ...
          you, the person log on this website and compliant to the Company terms
        ...
        <p>
          We employ the use of cookies. By accessing Savali Bahuddyeshiy
          Sanstha, you agreed to use cookies in agreement with the Savali
          Bahuddyeshiy Sanstha Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Savali Bahuddyeshiy Sanstha and/or its
          licensors own the intellectual property rights for all material on
          Savali Bahuddyeshiy Sanstha. All intellectual property rights are
          reserved. You may access this from Savali Bahuddyeshiy Sanstha for
        ...
        <ul>
          ...
          <li>
            Sell, rent or sub-license material from Savali Bahuddyeshiy Sanstha
          </li>
          <li>
            Reproduce, duplicate or copy material from Savali Bahuddyeshiy
            Sanstha
          </li>
        ...
        <p>
          ...
          <a href="https://www.termsconditiongenerator.com/">
        ...
        <p>
          ...
          Savali Bahuddyeshiy Sanstha does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Savali Bahuddyeshiy Sanstha, its
          ...
          by applicable laws, Savali Bahuddyeshiy Sanstha shall not be liable
        ...
        <p>
          Savali Bahuddyeshiy Sanstha reserves the right to monitor all Comments
        ...
        <p>
          You hereby grant Savali Bahuddyeshiy Sanstha a non-exclusive license
        ...
        <p>
          ...
          (c) fits within the context of the linking party site.
        </p>
        ...
        <p>
          ...
          the hyperlink compensates the absence of Savali Bahuddyeshiy Sanstha;
        ...
        <p>
          ...
          services; and (c) fits within the context of the linking party site.
        </p>

        <p>
          If you are one of the organizations listed in paragraph 2 above and
          are interested in linking to our website, you must inform us by
          sending an e-mail to Savali Bahuddyeshiy Sanstha. Please include your
        ...
        <p>
          No use of Savali Bahuddyeshiy Sanstha logo or other artwork will be
        ...
        <p>
          ...
          these terms and conditions and it is linking policy at any time. By
