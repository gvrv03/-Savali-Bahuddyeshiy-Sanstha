    ...
    <>
      <div className="bgGround   md:p-0 px-5 mt-[110px] h-[80vh] md:mt-[130px]">
        <div className="container m-auto">
          <Slide arrows={false} indicators={true} duration="500" ref={slideRef}>
              ...
              return (
                <>
                  <img
                    ...
                    alt={item}
                    key={index}
                    className="w-full h-[200px] rounded-xl md:h-[500px]  "
                  />
                </>
              );
            })}
          ...
          <div className="flex justify-between   md:flex-row flex-col gap-10 items-center  ">
            ...
            <div className="flex gap-5  md:w-auto w-full   flex-col md:flex-row">
              <button className="py-3 w-full items-center justify-center md:w-auto border  flex gap-5 md:rounded-full px-10 uppercase bg-red-500 text-white font-semibold  ">
                <i className="uil uil-phone text-xl " />
                <span  >Contact Us</span>
              </button>
              <button className="py-3 w-full md:w-auto flex items-center justify-center gap-5   border md:rounded-full px-10 uppercase font-semibold  ">
                <img
                  width="30"
                  height="30"
